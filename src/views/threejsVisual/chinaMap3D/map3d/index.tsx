...
import { drawLineBetween2Spot, generateMapLabel2D, generateMapObject3D, generateMapSpot, getDynamicMapScale } from "./drawFunc";
	...
	useEffect(() => {
		...
		loader.load("/models/cone.glb", glb => {
			label2dData.forEach((item: any) => {
				...
				// 设置模型位置
				clonedModel.position.set(featureCenterCoord[0], -featureCenterCoord[1], mapConfig.spotZIndex);
				// 设置模型大小
